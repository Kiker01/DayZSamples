...
class cfgWeapons
{
	...
	class JD_M416: JD_M416_Base
	{
		...
		model="JDweapons\Rifles\M416\HKM416.p3d";
		attachments[]=
		{
			"weaponOptics",
			"weaponFlashlight",
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 500;
					healthLevels[] = {{1.0,{"JDweapons\Rifles\M416\data\HK416_Body.rvmat","JDweapons\Rifles\M416\data\HK416_Material.rvmat","JDweapons\Rifles\M416\data\HK416_Material_Plastic.rvmat"}},{0.7,{"JDweapons\Rifles\M416\data\HK416_Body.rvmat","JDweapons\Rifles\M416\data\HK416_Material.rvmat","JDweapons\Rifles\M416\data\HK416_Material_Plastic.rvmat"}},{0.5,{"JDweapons\Rifles\M416\data\HK416_Body_Damage.rvmat","JDweapons\Rifles\M416\data\HK416_Material_Damage.rvmat","JDweapons\Rifles\M416\data\HK416_Material_Plastic_Damage.rvmat"}},{0.3,{}},{0.0,{"JDweapons\Rifles\M416\data\HK416_Body_Destruct.rvmat","JDweapons\Rifles\M416\data\HK416_Material_Destruct.rvmat","JDweapons\Rifles\M416\data\HK416_Material_Plastic_Destruct.rvmat"}}};
				};
			};
		};
...
class cfgVehicles
{
	...
	class JD_556_Suppressor: ItemSuppressor
	{
		...
		model="JDweapons\Rifles\M416\AACsuppressor.p3d";
		rotationFlags=17;
		reversed=0;
		weight=73;
		itemSize[]={3,1};
